...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{../results/horse_pops_plot.png}

}

\caption{\label{fig-all-provinces}Horse populations for all provinces in
Canada from 1906 - 1972.}

\end{figure}%

We can see from Figure~\ref{fig-all-provinces} that Ontario,
...
Province over the time period visualised in
Figure~\ref{fig-all-provinces} to further support this hypothesis.
...
span as Figure~\ref{fig-all-provinces}.

\begin{figure}

\centering{

\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{../results/horse_pops_plot_largest_sd.png}
